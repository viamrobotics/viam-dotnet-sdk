...
namespace Viam.Service.Generic.V1 {
  ...
  {
    static readonly string __ServiceName = "viam.service.generic.v1.GenericService";
    ...
    {
      get { return global::Viam.Service.Generic.V1.GenericReflection.Descriptor.Services[0]; }
    }
