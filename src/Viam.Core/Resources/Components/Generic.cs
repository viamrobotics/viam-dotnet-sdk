...
namespace Viam.Core.Resources.Components
{
    ...
    public class Generic(ResourceName resourceName, ViamChannel channel) : ComponentBase<Generic, GenericService.GenericServiceClient>(resourceName, new GenericService.GenericServiceClient(channel)), IGeneric
    {
