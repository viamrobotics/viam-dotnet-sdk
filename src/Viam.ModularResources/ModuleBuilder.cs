...
namespace Viam.ModularResources
{
    public class ModuleBuilder
    {
        ...
        public void RegisterService<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService>()
        ...
        public void RegisterComponent<TComponentInterface, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TComponent>() 
            ...
            where TComponent : class, IResourceBase, TComponentInterface, IModularResourceService
        {
            _hostBuilder.ConfigureServices(s =>
            {
                ...
                _postConfigureActions.Add(s =>
                {
                    var manager = s.GetRequiredService<ResourceManager>();
