...
namespace Viam.Serialization.Test
{
    public class DictionaryMapperTests
    {
        ...
        public void RoundTrip()
        {
            ...
            Assert.IsType<string>(sourceDict["Short"]);
            Assert.IsType<string>(sourceDict["UShort"]);
            Assert.IsType<string>(sourceDict["Int"]);
            Assert.IsType<string>(sourceDict["UInt"]);
            Assert.IsType<string>(sourceDict["Long"]);
            Assert.IsType<string>(sourceDict["ULong"]);
            Assert.IsType<string>(sourceDict["Float"]);
            Assert.IsType<string>(sourceDict["Double"]);
            Assert.IsType<string>(sourceDict["Decimal"]);
            Assert.IsType<string>(sourceDict["String"]);
            Assert.IsType<string>(sourceDict["Bool"]);
